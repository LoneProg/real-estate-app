  ...
  return (
    <SafeAreaView className='bg-white h-full'>
      <ScrollView contentContainerClassName='h-full'>
        <Image source={images.onboarding} className='flex w-full h-4/6 justify-center self-center' resizeMode='contain'/>
        <View className='px-10'>
          ...
          <TouchableOpacity onPress={handleLogin} className='bg-white shadow-md shadow-zinc-300 rounded-full w-full py-4 mt-5 mb-10'>
